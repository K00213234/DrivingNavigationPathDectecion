...
public class MatVectorDataImageGeneratorV5 implements VectorDataImageGenerator
{
	...
	public MatVectorDataImageGeneratorV5(JPanel displayJPanel)
	{
		this.displayJPanel = displayJPanel;

	}

	public MatVectorDataImageGeneratorV5(JPanel displayJPanel, Mat mat)
	{
		this.displayJPanel = displayJPanel;
		getSpace(mat);
	}
